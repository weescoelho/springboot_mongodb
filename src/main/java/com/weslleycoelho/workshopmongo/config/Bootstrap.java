package com.weslleycoelho.workshopmongo.config;
...
import com.weslleycoelho.workshopmongo.dto.AuthorDTO;
import com.weslleycoelho.workshopmongo.dto.CommentDTO;
...
public class Bootstrap implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    CommentDTO c2 = new CommentDTO("Aprovete", sdf.parse("22/03/2018"), new AuthorDTO(bob));
